...
urlpatterns = [
    ...
    path('inscripciones/<int:pk>/pagar/', views.RegistrationPayView.as_view(), name='registration_pay'),
    ...
    path('<str:slug>/admin/', views.PollAdminView.as_view(), name='poll_admin'),
]
